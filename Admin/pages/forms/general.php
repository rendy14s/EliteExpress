            ...
            <div class="col-md-9">
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title"><I>Input Data</I></h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <form role="form" action="input.php" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="awb" value="<?php echo acakangkahuruf(10) . rand(111111111,999999999) ?>">
                    </div>
                    <div class="form-group">
                      <label>Region</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="pt" class="form-control" placeholder="Nama Perusahaan...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="kode" id="prd_name" class="form-control">
                    ...
                    <label>Jenis Barang</label>
                     ...
                     <div class="form-group">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="jenis" value="Barang"> Barang
                        </label>
                      </div>
                      <div class="form-group">
                      <label>Uraian Isi Kiriman</label>
                      <textarea class="form-control" name="isi" rows="3" placeholder="Isi Kiriman ..."></textarea>
                    </div>
                    <div class="form-group">
                      <label>Berat Minimum</label>
                      <input type="text" name="min_berat" value="10Kg" class="form-control" readonly>
                    </div>
                    <div class="form-group">
